...
describe("Binary Search", () => {
  ...
  it("should search object in sorted array", () => {
    ...
    expect(binarySearch(sortedList, { key: 4 }, comparator)).toBe(-1);
    expect(binarySearch(sortedList, { key: 1 }, comparator)).toBe(0);
    expect(binarySearch(sortedList, { key: 2 }, comparator)).toBe(1);
    expect(binarySearch(sortedList, { key: 3 }, comparator)).toBe(2);
  });
});
