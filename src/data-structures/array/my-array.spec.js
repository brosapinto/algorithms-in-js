...
describe("MyArray", function() {
  ...
  describe(
    "concat(other) returns new array – result of concatenation" +
      " of current array with the other array",
    function() {
  ...
  describe(
    "findIndex(fn) returns the index of the first element that satisfies" +
      " fn(element) criterion",
    function() {
  ...
  describe(
    "map(fn) calls fn(element) for each element in the array in order and" +
      " returns new array composed out of return values",
    function() {
      ...
      it(
        "returns a mapped array when called on different array" +
          " with different mapping function",
        function() {
  ...
  describe(
    "filter(fn) returns new array that contains only elements that satisfied" +
      " fn(element) criterion",
    function() {
      it("returns an empty array when called on empty array", function() {
        var empty = new MyArray();
  ...
  describe(
    "fill(value, start=0, end=this.length()) fills array with static value" +
  ...
  describe(
    "slice(start=0, end=this.length()) returns a sub-array from start" +
      " index to end index",
    function() {
  ...
  describe(
    "splice(start, deleteCount=MAX, ...items) replaces contents of the array" +
      " specified by start and deleteCount with items provided as arguments",
    function() {
